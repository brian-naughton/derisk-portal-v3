...
export function ScorePanel({ data, currentScore, delta }: ScorePanelProps) {
  ...
  return (
    <div className="panel-score">
      {/* Module label */}
      <div className="section-heading"><span style={{ color: 'var(--db-accent)' }}>Module:</span> <span style={{ color: '#fff' }}>Time Machine</span></div>
      ...
      <div className={`score-hero ${glowClass}`}>
        ...
        <div className={`score-label ${labelClass}`}>{getRiskLabel(currentScore, data.exploit_id)}</div>
      </div>
