    ...
    <>
      ...
      <section className="post-demo-hero">
        <div className="hero-content">
          <div className="hero-stealth-label">Still in stealth mode</div>
        ...
        <div className="hero-content">
          ...
          >
            <h2 className="punchline-headline">
              The <span style={{ color: '#a10b2b' }}>Time Machine</span> demo above is not a<br />proof-of-concept.
            </h2>
            ...
            <p className="punchline-text">
              ...
              Point it at any chain, any VM, any smart contract — same language, same threat detection capabilities.
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="hero-section hero-dissolve">
        <div className="hero-content" style={{ textAlign: 'center' }}>
          <h2 className="hero-headline" style={{ color: '#ffe600' }}>Our Origin Story</h2>
